...
local char,mouse = game.Workspace.non,plr:GetMouse()
...
local hat = Align(char['AssistantDroneAccessory'].Handle,o99,false)
local cf = o99.CFrame*CFrame.new(0,0,0)*CFrame.Angles(math.rad(-100),math.rad(0),-4.7)
hat[1].CFrame = cf:Inverse() * o99.CFrame
spawn(function()
...
o109.Position = Vector3.new(12.0515394, 40.7946739, -70.0561295)
o1.PrimaryPart = o109
s.SoundId = "rbxassetid://1470848774"
s.Parent = o1.PrimaryPart
s.Pitch = 1
s.Volume = 1
s.Looped = true
...
mouse.KeyDown:connect(function(key)
	if key == "b" then
		if fly == false then
			...
			cMsg("Remote control!")
			local args = {
    [1] = "🤖DRONE🤖: Remote Control activated!",
    [2] = "All"
}
