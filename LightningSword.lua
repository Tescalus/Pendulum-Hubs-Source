...
game.Workspace.non.Humanoid.WalkSpeed = 40
...
local DamageFling = function(DmgPer)
	if HumanDead or Bypass ~= "death" or DmgPer.Name == game.Players.LocalPlayer.Name or DmgPer.Name == "non" or CDDF[DmgPer] or not DmgPer or not DmgPer:FindFirstChildOfClass("Humanoid") or DmgPer:FindFirstChildOfClass("Humanoid").Health <= 0 then return end
	...
	for _=1,20 do
        local PosFling = (((DmgPer:FindFirstChild("HumanoidRootPart") and DmgPer:FindFirstChild("HumanoidRootPart") .CFrame) or (DmgPer:FindFirstChildOfClass("Part") and DmgPer:FindFirstChildOfClass("Part").CFrame))*CFrame.new(0,0.5,0)).p
...
athp.Position = Vector3.new(0,4,0)
atho.Rotation = Vector3.new(0,0,-150)
for i = 0,1,0.1 do
swait()
