...
local typing = false
local crit = false
local critchance = 0 --critical chance percentage
local critdamageaddmin = 0--minimum amount of critical damage being added to regular damage
local critdamageaddmax = 0 --maximum amount
...
local mindamage = 0 --self explanatory
local maxdamage = 0 --self explanatory
local damagevalue = 0--how much damage this character has
