...
C:NewLabel("Pendulum Hub made by Tescalus#0001")

C:NewLabel("All GUI and script creators go to their original owners.")

C:NewLabel("Join the discord https://discord.gg/GqbM5WEPdq")
