...
-- // Modules/Setup
local discord123 = "https://discord.gg/wJV63vJqMy"
game.StarterGui:SetCore("SendNotification", {
    Title = "Pendulum Reanim";
    Text = "If you want to use Pendulum Hub a discord link has been copied to your clipboard.";
    Duration = "300";
    
    
    
    Icon = "rbxassetid://8955607825";
    Callback = setclipboard(discord123)
})
...
if getgenv().ShowReal == nil then getgenv().ShowReal = true end
...
if getgenv().Tools == nil then getgenv().Tools = false end
