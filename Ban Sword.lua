...
local Hat = game.Players.LocalPlayer.Character.MARTILLO
...
Align(Hat.Handle,AlignPart,Vector3.new(0,0,0),Vector3.new(0,90,0))
Align(Hat.Handle,AlignPart,Vector3.new(0,0,0),Vector3.new(0,90,0))
...
if _G.PDeath == true or _G.R15Bullet == true then
    ...
    local Highlight = Instance.new("SelectionBox")
        ...
        Highlight.Color3 = Color3.fromRGB(34,176,229)
        ...
        Align(hrp,AlignPart,Vector3.new(0,4,0),Vector3.new(0,0,0))
     Align(hrp,AlignPart,Vector3.new(0,4,0),Vector3.new(0,0,0))
    spawn(function()
    while game:GetService("RunService").Heartbeat:Wait() do
    hrp.Velocity = Vector3.new(30,0,0)
    end
    end)
end
